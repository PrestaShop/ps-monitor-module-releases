...
<html lang="en">
  ...
  <body>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      ...
      <p class="lead">Static HTML page that displays monitored modules git status. Built on GitHub Actions, GitHub pages on <a href="https://github.com/matks/ps-monitor-module-releases">matks/ps-monitor-module-releases</a></p>
    </div>
